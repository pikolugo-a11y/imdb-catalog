...
test('reset conserva evidencia externa de Personas sin tratarla como estado derivado del catálogo',()=>{assert.match(reset,/PRESERVE_TABLES[^;]*person_filmography/s);assert.doesNotMatch(reset,/RESET_TABLES[^;]*person_filmography/s)});
