...
test('reset contempla read models y derivados detectados en producción',()=>{for(const table of ['catalog_read_model','movie_countries','movie_country_names','movie_genre_names','movie_genres_canonical','title_ratings'])assert.match(reset,new RegExp(`'${table}'`))});
