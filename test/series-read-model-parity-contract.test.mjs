...
test('SER-002 mantiene paridad del read model también para series recién incorporadas',()=>{
  assert.match(plexWorker,/async function executeSer002[\s\S]*syncPlexSeriesDetailCore\(id,\{trace\}\);await rebuildSeriesQualityReadModelForRatingKey\(sql,id\)/);
});
