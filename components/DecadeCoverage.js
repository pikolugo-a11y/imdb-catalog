import styles from './DecadeCoverage.module.css';
export default function DecadeCoverage({rows=[]}){
  ...
  return <section className={`${styles.root} dashboard-panel decade-v2`}><div className="section-head"><div><div className="eyebrow">Cobertura histórica</div><h2>Evolución del catálogo por décadas</h2><p>Volumen del catálogo y proporción disponible actualmente en Plex.</p></div></div>
