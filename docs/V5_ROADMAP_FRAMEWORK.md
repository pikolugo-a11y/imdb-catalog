...
- Punto 4 — Procesos automáticos y Batch: **FASE 1 CERRADA; Fase 2 CERRADA con PROC-01 a PROC-10 aprobadas; Fase 3 de innovación ACTIVA** (`V5_AUDIT_04_PROCESSES_BATCH.md`; `V5_DECISIONS_04_PROCESSES_BATCH.md`)
