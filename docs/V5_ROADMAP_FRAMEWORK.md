...
- Punto 5 — Observabilidad y errores: **FASE 1 CERRADA — auditoría extremadamente detallada completada; Fase 2 de propuestas ACTIVA** (`V5_AUDIT_05_OBSERVABILITY_ERRORS.md`)
