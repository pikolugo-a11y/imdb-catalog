...
- Punto 4 — Procesos automáticos y Batch: **FASE 1 CERRADA — auditoría completada; Fase 2 activa; PROC-01 a PROC-05 aprobadas** (`V5_AUDIT_04_PROCESSES_BATCH.md`; `V5_DECISIONS_04_PROCESSES_BATCH.md`)
