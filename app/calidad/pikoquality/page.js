...
export default async function Page(){
  ...
  return <div className={styles.page}>
    ...
    <div className={styles.adminNote}>ⓘ Cada análisis unitario queda registrado en <Link href="/admin">Admin</Link>. No hay un segundo botón de confirmación: el análisis correcto actualiza lifecycle en la misma operación.</div>
  </div>;
}
