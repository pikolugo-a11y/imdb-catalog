...
export default async function Calidad(){
  ...
  return <div className="qv4-page">
    ...
    <section className="qv4-hybrid-grid">
      ...
      <Link href="/calidad/relevancia" className="qv4-surface relevance"><div className="qv4-surface-head"><span className="qv4-surface-icon">◎</span><span className="qv4-surface-badge">Página especializada</span></div><h3>PikoRelevancia</h3><p>Prioriza las series por relevancia real en España sin convertir el cálculo en una fase del Lifecycle.</p><div className="qv4-area-list"><div className="qv4-area-row"><span>Pendientes iniciales</span><b className={home.relevancePending?'pending':''}>{nf(home.relevancePending)}</b></div><div className="qv4-area-row"><span>Mantenimiento posterior</span><b>Automático</b></div><div className="qv4-area-row"><span>Media Cloud</span><b>1 serie a la vez</b></div></div><div className="qv4-surface-cta"><span>Abrir PikoRelevancia</span><b>→</b></div></Link>
    </section>
