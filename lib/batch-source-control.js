...
const SOURCES=new Set(['tmdb','omdb','wikidata','filmaffinity','fast','plex']);
...
async function probe(source){
  ...
  if(source==='omdb'){
    ...
    const r=await fetchProbe(`https://www.omdbapi.com/?apikey=${encodeURIComponent(key)}&i=tt0111161&r=json`,{headers:{'User-Agent':'PikoFilm/3.0'}});
    return r;
  }
