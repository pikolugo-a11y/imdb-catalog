 ...
 * ventana conservadora de 90 días tras el estreno cinematográfico. Si Plex ya contiene
 * el título, esa presencia física demuestra disponibilidad y prevalece sobre la ventana.
 */
const availabilitySql=`CASE
  WHEN m.imdb_id IS NULL OR ex.imdb_id IS NOT NULL THEN 'outside_catalog'
  WHEN c.effective_status='in_plex' THEN 'available'
