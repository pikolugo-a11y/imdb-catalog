...
const SORTS=new Set(['score','relevance','spain','year','title']);
...
export async function getCatalogV4(raw={}){
  ...
  const sql=db(),params=[PIKOQUALITY_ACTIVE_VERSION,PIKORELEVANCE_VERSION],where=whereSql(p,params),order=orderSql(p);
