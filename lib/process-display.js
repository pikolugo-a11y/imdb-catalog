...
const entityLabels={title:'Título',movie:'Película',series:'Serie',series_library:'Biblioteca de series',season:'Temporada',episode:'Episodio',discovery:'Discovery',person:'Persona',saga_universe:'Sagas',saga_collection:'Saga',tmdb_movie:'Película TMDb'};
const triggerLabels={calidad_identidad_manual:'Manual desde Calidad',calidad_validacion_identidad_manual:'Manual desde Validación de identidad',calidad_datos_manual:'Manual desde Datos',calidad_peliculas_manual:'Manual desde Películas',calidad_series_manual:'Manual desde Series',novedades_manual:'Manual desde Novedades',sagas_manual:'Manual desde Sagas',personas_manual:'Manual desde Personas',catalog_exclusions_manual:'Manual desde Excluidas',operations_manual:'Manual desde Operaciones'};
