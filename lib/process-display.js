const processCatalog={
  ...
  'PROC-NOV-005':{name:'Excluir candidato de Novedades'},
...
const entityLabels={title:'Título',movie:'Película',series:'Serie',series_library:'Biblioteca de series',season:'Temporada',episode:'Episodio',discovery:'Discovery',person:'Persona',saga_universe:'Sagas',saga_collection:'Saga',tmdb_movie:'Película TMDb',pikoquality:'PikoQuality',plex_library:'Biblioteca Plex',plex_item:'Elemento Plex'};
