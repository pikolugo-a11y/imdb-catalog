...
export function classifySeries(row,now=new Date()){
  ...
  if(!row.has_reference){primaryState='pre_quality';severity='warn';diagnosis={code:'PRE_QUALITY',label:'Preparando referencia',detail:'Todavía no existe la referencia oficial TMDb de episodios para esta serie',severity};nextAction={code:'AUTO_PREPARE_REFERENCE',label:'Seguimiento automático',automatic:true};}
