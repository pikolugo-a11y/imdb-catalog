...
export async function getNewsV1(filters={}){
  ...
  return {rows,stats:stats||{total:0,movies:0,series:0,spanish_rescues:0,manual:0},excludedCount:excludedStats?.total||0,latestRun:latestRun||null,lastSuccess:lastSuccess||null,nextAllowedAt,discoveryAllowed,testOverrideAvailable,testOverrideUpdatedAt:overrideRow?.updated_at||null,page,pageSize};
}
