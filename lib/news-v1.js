...
function deriveState(row){
  ...
  if(origin==='manual'){
    // El alta manual entra por la misma máquina de estados que Plex/Discovery:
    // mientras la resolución autoritativa no haya terminado, sigue preparando.
    // Los datos rápidos de IMDb/TMDb pueden servir de previsualización, pero no
    // habilitan la incorporación al Catálogo por sí solos.
