...
function buildCounts(classified){
  ...
  const episodes={physical:0,present:0,physicalMissing:0,missing:0,actionable:0,spain:0,noes:0,premiere:0};
  for(const r of classified){
    ...
    episodes.noes+=n(r.episode_pending_noes);
...
export async function getSeriesQualityV3(filters={}){
  ...
  const episodeField={missing:'episode_missing_total',actionable:'episode_actionable_now',spain:'episode_pending_spain',noes:'episode_pending_noes',premiere:'episode_pending_premiere'}[episodeState]||null;
