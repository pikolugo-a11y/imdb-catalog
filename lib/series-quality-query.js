...
export async function getSeriesQualityV3(filters={}){
  ...
  filtered.sort((a,b)=>{
    if(sort==='missing_asc')return(n(a.episode_missing_total)-n(b.episode_missing_total))||fallback(a,b);
    if(sort==='missing_desc')return(n(b.episode_missing_total)-n(a.episode_missing_total))||fallback(a,b);
