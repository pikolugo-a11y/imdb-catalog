...
export async function getCatalogV3(filters={}){
  ...
  return sql`SELECT c.imdb_id,c.type,c.display_title,c.original_title,c.year,c.runtime,
    COALESCE(cn.countries_es,c.country) country,c.final_rating,c.imdb_rating,c.imdb_votes,c.fa_rating,c.fa_votes,c.tmdb_rating,c.tmdb_votes,
    ...
    ORDER BY
      ...
      CASE WHEN ${sort}='score' AND ${dir}='asc' THEN c.final_rating END ASC NULLS LAST,
      CASE WHEN ${sort}='score' AND ${dir}='desc' THEN c.final_rating END DESC NULLS LAST,
      ...
      c.final_rating DESC NULLS LAST,c.imdb_votes DESC NULLS LAST,c.imdb_id
