...
export const QUALITY_STAGE_META=Object.freeze([
  ...
  {id:'pikoquality',label:'PikoQuality',href:'/calidad/pikoquality',description:'Películas o temporadas con prioridad alta de mejora',cta:'Ver prioridades',branch:'physical'}
]);
...
function statusFor(id,count,counts){
  ...
  if(id==='pikoquality'&&count>0)return{key:'attention',label:'Mejorable',icon:'!'};
