...
export const CONFIGURABLE_AUTOMATIONS=[
  ...
  {code:'PROC-REL-001',title:'PikoRelevancia',domain:'Calidad',description:'Recalcula automáticamente la relevancia de series que ya tienen una valoración previa.',dueText:'Cadencia adaptativa: frecuente en series nuevas o activas, progresivamente menor con la edad y nula en series extremadamente antiguas.'},
];
